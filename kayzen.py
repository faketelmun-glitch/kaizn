...
__CHANNEL_USERNAME__ = "KayzenShopChannel"
__GROUP_USERNAME__   = "KayzenShopChat"
...
def banner(console):
    ...
    brand_name =  "Car Parking Multiplayer 1 Tool - t.me/Telmun61"
    colors = [
...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        print(Colorate.Horizontal(Colors.rainbow, f'Name      : {(response.get("Name") if "Name" in response else "UNDEFINED")}.'))
            
        print(Colorate.Horizontal(Colors.rainbow, f'LocalID   : {response.get("LocalId")}.'))
        
        print(Colorate.Horizontal(Colors.rainbow, f'Money     : {response.get("Money")}.'))
        
        print(Colorate.Horizontal(Colors.rainbow, f'Coins     : {response.get("Coin")}.'))
        
        print(Colorate.Horizontal(Colors.rainbow, f'OwnedCars : {response.get("OwnedCars")}.'))
...
def load_key_data(cpm):
    ...
    print(Colorate.Horizontal(Colors.rainbow, f'Device Name: {data.get("device_name")}.'))
...
def load_client_details():
    ...
    if country != "Mongolia":
        print(Colorate.Horizontal(Colors.rainbow, "! ERROR: This tool only works in Mongolia !"))
        exit(1)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{11}: Unlock w16 Engine        4K'))
            print(Colorate.Horizontal(Colors.rainbow, '{12}: Unlock All Horns         3K'))
            print(Colorate.Horizontal(Colors.rainbow, '{13}: Unlock Disable Damage    3K'))
            print(Colorate.Horizontal(Colors.rainbow, '{14}: Unlock Unlimited Fuel    3K'))
            print(Colorate.Horizontal(Colors.rainbow, '{15}: Unlock House 3           4K'))
            print(Colorate.Horizontal(Colors.rainbow, '{16}: Unlock Smoke             4K'))
            print(Colorate.Horizontal(Colors.rainbow, '{17}: Unlock Wheels            4K'))
            print(Colorate.Horizontal(Colors.rainbow, '{18}: Unlock Animations        2K'))
            print(Colorate.Horizontal(Colors.rainbow, '{19}: Unlock Equipaments M     3K'))
            print(Colorate.Horizontal(Colors.rainbow, '{20}: Unlock Equipaments F     3K'))
            print(Colorate.Horizontal(Colors.rainbow, '{21}: Change Race Wins         1K'))
            print(Colorate.Horizontal(Colors.rainbow, '{22}: Change Race Loses        1K'))
            print(Colorate.Horizontal(Colors.rainbow, '{0} : Exit'))
            
            print(Colorate.Horizontal(Colors.rainbow, '===============[ Kayzen ]==============='))
            ...
            if service == 0: # Exit
                ...
                if cpm.unlock_wheels():
                    ...
                    sleep(2)
                    continue
            elif service == 18: # Unlock Animations
                ...
                if cpm.unlock_animations():
                    ...
                    sleep(2)
                    continue
            elif service == 19: # Unlock Equipments Male
                console.print("[%] Unlocking Male Equipments: ", end=None)
                if cpm.unlock_equipments_male():
                    ...
                    sleep(2)
                    continue
            elif service == 20: # Unlock Equipments Female
                console.print("[%] Unlocking Female Equipments: ", end=None)
                if cpm.unlock_equipments_female():
                    ...
                    sleep(2)
                    continue
            elif service == 21: # Change Race Wins
                print(Colorate.Horizontal(Colors.rainbow, '[?] Insert how many race wins do you want.'))
                amount = IntPrompt.ask("[?] Amount")
                console.print("[%] Saving your data: ", end=None)
                if amount > 0 and amount <= 1000000:
                    ...
                    sleep(2)
                    continue
            elif service == 22: # Change Race Loses
                print(Colorate.Horizontal(Colors.rainbow, '[?] Insert how many race loses do you want.'))
                amount = IntPrompt.ask("[?] Amount")
                console.print("[%] Saving your data: ", end=None)
                if amount > 0 and amount <= 1000000:
